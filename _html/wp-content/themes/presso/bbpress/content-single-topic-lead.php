...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-author header-font"><?php  _e( 'Creator',  'bbpress' ); ?></div><!-- .bbp-topic-author -->

		<div class="bbp-topic-content header-font">
	...
	<li class="bbp-footer">
		...
		<div class="bbp-topic-author header-font"><?php  _e( 'Creator',  'bbpress' ); ?></div>
