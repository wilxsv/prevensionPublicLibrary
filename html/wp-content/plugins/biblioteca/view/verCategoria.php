<?php
	...
	if ($_GET['categoria'] > 0) { $query .= " AND c.idclase = '".$_GET['categoria']."' "; }
	if ($_GET['componente'] > 0) { $query .= " AND h.idcomponente = '".$_GET['componente']."' "; }
	if ($_GET['tipo'] > 0) { $query .= " AND h.idtipoherramienta = '".$_GET['tipo']."' "; }
	$query .= "ORDER BY 7 ;";
