<?php
defined( 'VW_DEMO_IMPORT_PATH' ) || define( 'VW_DEMO_IMPORT_PATH', get_template_directory().'/framework/demo-importer' );
defined( 'VW_DEMO_IMPORT_SAMPLE_HOME' ) || define( 'VW_DEMO_IMPORT_SAMPLE_HOME', 'Home' );
defined( 'VW_DEMO_IMPORT_SAMPLE_BLOG' ) || define( 'VW_DEMO_IMPORT_SAMPLE_BLOG', 'Blog' );
...
if ( ! function_exists( 'vwdemo_setup_menu' ) ) {
	function vwdemo_setup_menu() {
		...
		if ( isset( $top_menu->term_id ) ) {
			$locations['top_navigation'] = $top_menu->term_id;
		}

		$main_menu = get_term_by( 'slug', $main_menu_slug, 'nav_menu' );
		if ( isset( $main_menu->term_id ) ) {
			$locations['main_navigation'] = $main_menu->term_id;
		}
