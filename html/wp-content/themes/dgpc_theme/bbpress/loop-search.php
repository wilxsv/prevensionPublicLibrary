...
<ul id="bbp-search-results" class="forums bbp-search-results">
	...
	<li class="bbp-header">
		...
		<div class="bbp-search-author header-font"><?php  _e( 'Author',  'bbpress' ); ?></div><!-- .bbp-reply-author -->

		<div class="bbp-search-content header-font">
	...
	<li class="bbp-footer">
		...
		<div class="bbp-search-author header-font"><?php  _e( 'Author',  'bbpress' ); ?></div>
